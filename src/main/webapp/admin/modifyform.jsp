				...
				<div id="content">
					<div class="page_aticle">
						<div class="head_aticle">
							<h2 class="tit">도서 수정<span class="tit_sub">도서정보를 수정하여 도서 목록을 업데이트하세요.</span>
							</h2>
						</div>
					<div>
					<%
					...
					%>
						...
						<!--  enctype="multipart/form-data" 속성은 파일이나 이미지를 서버로 전송할 때 사용한다. 수정에는 파일전송을 넣지 않음-->
							...
							<div class="col-5">
								...
								<input class="form-control" type="number" name="discount-price" value="<%=book.getDiscountPrice() %>"/>
